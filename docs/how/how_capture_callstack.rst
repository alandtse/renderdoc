...
Even if you choose to ignore a PDB, RenderDoc will automatically load it without prompting if the file later appears in its expected location or any previously used symbol search paths.
